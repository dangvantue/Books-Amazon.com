...
public class ReviewVoteService {
	...
	public void markReviewsVotedForBookByCustomer(List<Review> listReviews, Integer bookId,
			Integer customerId) {
		List<ReviewVote> listVotes = voteRepo.findByBookAndCustomer(bookId, customerId);
